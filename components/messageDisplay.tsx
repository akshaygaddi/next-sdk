...
export const Message = React.memo(
  ({ message, currentUser, showAvatar = true }) => {
          ...
          return (
            <>
              <Card
                ...
                onClick={() =>
                  message.metadata?.metadata?.url && setShowPreview(true)
                }
              >
                <div className="relative">
              ...
              <div className="flex items-center gap-2">
                ...
                {message.metadata?.metadata?.duration && (
                  <span className="text-xs text-muted-foreground">
                    ...
                    {String(message.metadata.metadata.duration % 60).padStart(
                      2,
                      "0",
                    )}
                  </span>
    ...
    return (
      ...
      >
        ...
        <div
          className={`flex-1 max-w-2xl ${isOwnMessage ? "items-end" : "items-start"}`}
        >
          <div
