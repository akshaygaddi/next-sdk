...
const ExpiryCountdown = memo(
  ({ expiresAt, onExpired, onExpiringSoon, hasJoined, isCreator }) => {
...
const RoomCard = memo(
  ({
    ...
    const isExpired =
      roomData.expires_at && new Date(roomData.expires_at) < new Date();
      ...
      >
            ...
            <div className="flex items-center gap-1">
              ...
              {!hasJoined && !isExpired && (
                <IconButton
                  icon={DoorOpen}
                  onClick={() =>
                    isPrivate ? setShowPasswordDialog(true) : handleJoinRoom()
                  }
                        ...
                        <AlertDialogContent className="rounded-lg shadow-lg bg-white dark:bg-gray-800 p-6">
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription className="text-sm text-gray-600 dark:text-gray-400 mt-2">
                              This action cannot be undone. All participants
                              will be removed, and the room will be permanently
                              closed.
                            </AlertDialogDescription>
                          </AlertDialogHeader>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          ...
                          removed and the room will be permanently closed.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
                ...
                <ScrollArea className="h-64">
                  <div className="space-y-2">
                    {participants.map((participant) => {
                      const isOnline =
                        new Date(participant.last_activity).getTime() >
                        Date.now() - 5 * 60 * 1000;
        ...
        >
          <AlertDialogContent>
            ...
            <AlertDialogFooter>
              <AlertDialogCancel>Cancel</AlertDialogCancel>
              <AlertDialogAction onClick={handleJoinRoom} disabled={!password}>
                Join Room
              </AlertDialogAction>
            </AlertDialogFooter>
          </AlertDialogContent>
