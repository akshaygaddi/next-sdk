...
export default function RoomChat({ room, initialParticipant }: RoomChatProps) {
    ...
    const handleTerminateRoom = async () => {
        if (!currentUser || currentUser.id !== room.created_by) {
            toast({
                title: "Error",
                description: "Only the room creator can terminate the room.",
                variant: "destructive",
            })
            return
        }
        ...
        if (error) {
            ...
            toast({
                title: "Error",
                description: `Failed to terminate the room: ${error.message}`,
                variant: "destructive",
            })
        } else {
            toast({
        ...
        <div className="flex h-screen bg-background">
            ...
            <div className="flex-1 flex flex-col max-w-full">
                ...
                <div className="p-4 border-t border-border bg-card">
                    ...
                    {isTyping && (
                        <p className="text-xs text-muted-foreground mt-1">Someone is typing...</p>
                    )}
                </div>
            </div>
        </div>
